...
# ./create --token= --min=1 --max=1 --prefix=saltmaster --saltmaster
# ./create --token= --min=1 --max=1 --prefix=db --saltmaster_address=
# ./create --token= --min=1 --max=3 --prefix=fe --saltmaster_address=
